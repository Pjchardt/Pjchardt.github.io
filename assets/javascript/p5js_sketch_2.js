/**
 * CCapture Bouncing Colorful Balls Demo (v1.1.0)
 * GoToLoop (2018-Jun-26)
 *
 * https://Discourse.Processing.org/t/
 * how-to-save-your-p5-js-sketch-as-a-gif-using-ccapture-js/1264/2
 *
 * https://Glitch.com/~ccapture-bouncing-colorful-balls-demo
 * https://Bl.ocks.org/GoSubRoutine/60b154e52336f7fee7c5f1fe817ceb22
...
function setup() {
  ...
  button = createButton('Record Gif Record Gif Record Gif Record Gif Record Gif');
  button.parent('sketch-holder');
  button.style('display', 'inline');
  button.style('font-size', '36px');
  button.style('line-height', '40px')
  button.style('background-color', 'rgba(125, 125, 125, 75)')
  button.mousePressed(makeGif);
...
function draw() {
  ...
  // strokeWeight(0.5);
  // if (frameCount % 300 == 0) {
  //   button.style('background-color', "#" + hex(random(255),2) + hex(random(255),2) + hex(random(255),2)); 
  // }
